...
public class HangulUtilsTest {
    ...
    public void testFormalPolitePresentStatementConjugation() {
        String conjugated1 = HangulUtils.conjugatePresent(VERB_1, SpeechForm.FORMAL_POLITE, ConjugationType.STATEMENT);
        String conjugated2 = HangulUtils.conjugatePresent(VERB_2, SpeechForm.FORMAL_POLITE, ConjugationType.STATEMENT);
        String conjugated3 = HangulUtils.conjugatePresent(VERB_3, SpeechForm.FORMAL_POLITE, ConjugationType.STATEMENT);
        String conjugated4 = HangulUtils.conjugatePresent(VERB_4, SpeechForm.FORMAL_POLITE, ConjugationType.STATEMENT);
    ...
    public void testFormalPolitePresentQuestionConjugation() {
        String conjugated1 = HangulUtils.conjugatePresent(VERB_1, SpeechForm.FORMAL_POLITE, ConjugationType.QUESTION);
        String conjugated2 = HangulUtils.conjugatePresent(VERB_2, SpeechForm.FORMAL_POLITE, ConjugationType.QUESTION);
        String conjugated3 = HangulUtils.conjugatePresent(VERB_3, SpeechForm.FORMAL_POLITE, ConjugationType.QUESTION);
        String conjugated4 = HangulUtils.conjugatePresent(VERB_4, SpeechForm.FORMAL_POLITE, ConjugationType.QUESTION);
    ...
    public void testFormalPolitePresentCommandConjugation() {
        String conjugated1 = HangulUtils.conjugatePresent(VERB_1, SpeechForm.FORMAL_POLITE, ConjugationType.COMMAND);
        String conjugated2 = HangulUtils.conjugatePresent(VERB_2, SpeechForm.FORMAL_POLITE, ConjugationType.COMMAND);
        String conjugated3 = HangulUtils.conjugatePresent(VERB_3, SpeechForm.FORMAL_POLITE, ConjugationType.COMMAND);
        String conjugated4 = HangulUtils.conjugatePresent(VERB_4, SpeechForm.FORMAL_POLITE, ConjugationType.COMMAND);
    ...
    public void testFormalPolitePresentProposalConjugation() {
        String conjugated1 = HangulUtils.conjugatePresent(VERB_1, SpeechForm.FORMAL_POLITE, ConjugationType.PROPOSAL);
        String conjugated2 = HangulUtils.conjugatePresent(VERB_2, SpeechForm.FORMAL_POLITE, ConjugationType.PROPOSAL);
        String conjugated3 = HangulUtils.conjugatePresent(VERB_3, SpeechForm.FORMAL_POLITE, ConjugationType.PROPOSAL);
        String conjugated4 = HangulUtils.conjugatePresent(VERB_4, SpeechForm.FORMAL_POLITE, ConjugationType.PROPOSAL);
